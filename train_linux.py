...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT /'zifu/zifu_model.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'zifu/zifu_parameter.yaml', help='dataset.yaml path')
