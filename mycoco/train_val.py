...
copy_file('../yolov5-6.0/zifu/datasets/images/train/', './images_train.txt', './all_images')
copy_file('../yolov5-6.0/zifu/datasets/images/val/', './images_trainval.txt', './all_images')
copy_file('../yolov5-6.0/zifu/datasets/labels/train/', './labels_train.txt', './all_labels')
copy_file('../yolov5-6.0/zifu/datasets/labels/val/', './labels_trainval.txt', './all_labels')
